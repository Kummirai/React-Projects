...
function MoviesDetails({navLinks,movie}) {
    return (
        ...
        backgroundPosition: "top center",
            ...
            <div className="col-sm-6 flex-grow-1 p-5 pb-2 d-flex flex-column justify-content-start z-2">
                ...
                <div className="m-auto text-white px-5 py-4 rounded-4"
                style={{backgroundColor: "rgba(0, 0, 0, 0.5)"}}>
                    ...
                    <p className="text-white">February * {movie?.first_air_date.slice(0, 4)}</p>
